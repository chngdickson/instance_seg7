...
def run(
    ...
    for batch_i, (im, targets, paths, shapes, masks) in enumerate(pbar):
        ...
        with dt[2]:
            print(lb, single_cls, max_det, nm)
        ...
        for si, pred in enumerate(out):
            ...
            if save_json:
                ...
                add_coco_annotation(predn, coco_json, path, class_map, pred_masks)
    ...
    if save_json and len(jdict):
        ...
        pred_json_all = str(save_dir / f"{w}_predictions2.json")
        ...
        #     anno = COCO(pred_json_all)  # init annotations api
        #     pred = anno.loadRes(pred_json_all)  # init predictions api
